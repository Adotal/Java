...
public class Principal extends JFrame implements ActionListener{
 ...
 private JMenu menuOptions, menuCal, menuInf, submenuColors;
 ...
 public Principal(){
  ...
  menuCal.setBackground(new Color(255,10,10));
  menuCal.setFont(new Font("Andale Mono", 1, 14));
  menuCal.setForeground(new Color(255,255,255));
  menubar.add(menuCal);

  object6 = new JMenuItem("Vacaciones");
  object6.setFont(new Font("Andale Mono", 1, 14));
  object6.setForeground(new Color(255,10,10));
 ...
 public void actionPerformed(ActionEvent e){
  ...
  if(e.getSource() == object6){  //Vacaciones//
